...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              return (
                <Card key={idx} className="border-border bg-card p-6 text-center hover:shadow-md transition-shadow">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              return (
                <Card key={idx} className="border-border bg-card p-8 hover:shadow-lg transition-shadow">
      ...
      {/* CTA Section */}
      <section className="border-t border-border bg-primary text-primary-foreground py-16 sm:py-24">
