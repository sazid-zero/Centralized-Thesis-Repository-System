        ...
        <div className="flex h-screen bg-background">
            ...
            <main className="flex-1 overflow-y-auto mb-20 md:mb-0">
                <div className="border-b border-border bg-card p-4 sm:p-6">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground mt-1">Manage supervision requests and monitor student progress</p>
                </div>
                ...
                <div className="p-4 sm:p-6 space-y-6 sm:space-y-8">
                    ...
                    <Tabs defaultValue="requests" className="w-full">
                        <TabsList className="grid w-full grid-cols-4 mb-4 sm:mb-6">
                            <TabsTrigger value="requests" className="text-xs sm:text-sm">Requests ({pendingRequests.length})</TabsTrigger>
                            <TabsTrigger value="progress" className="text-xs sm:text-sm">In Progress ({inProgress.length})</TabsTrigger>
                            <TabsTrigger value="review" className="text-xs sm:text-sm">Review ({pendingReview.length})</TabsTrigger>
                            <TabsTrigger value="published" className="text-xs sm:text-sm">Published ({published.length})</TabsTrigger>
                        </TabsList>
                                ...
                                <Card key={project.id} className="border-border bg-card p-4 sm:p-6">
                                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                        <div className="flex-1 min-w-0 space-y-2">
                                            ...
                                            <p className="text-xs sm:text-sm text-muted-foreground line-clamp-2">{project.abstract}</p>
                                            <p className="text-xs text-muted-foreground">Submitted {new Date(project.createdAt).toLocaleDateString()}</p>
                                        </div>
                                ...
                                <Card key={project.id} className="border-border bg-card p-4 sm:p-6">
                                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                        <div className="flex-1 min-w-0 space-y-2">
                                            ...
                                            <p className="text-xs sm:text-sm text-muted-foreground line-clamp-2">{project.abstract}</p>
                                            <p className="text-xs text-muted-foreground">Published {new Date(project.createdAt).toLocaleDateString()}</p>
                                        </div>
