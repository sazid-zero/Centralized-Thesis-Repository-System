                ...
                <div className="border-b border-border bg-card p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                        <div>
                            ...
                            <p className="text-xs sm:text-sm text-muted-foreground mt-1">Manage your personal research and collaborations</p>
                        </div>
                        <Button
                                ...
                                <div className="flex-1 min-w-0 space-y-2 sm:space-y-3">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        {research.published_date && (
                                            <p className="text-xs sm:text-sm text-muted-foreground">
                                                <span className="font-medium">Published:</span> {new Date(research.published_date).toLocaleDateString()}
                                            </p>
                                        )}
                                    </div>
                                </div>
